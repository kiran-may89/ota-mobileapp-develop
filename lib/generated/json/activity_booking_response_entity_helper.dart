...
activityBookingResponseEntityFromJson(ActivityBookingResponseEntity data, Map<String, dynamic> json) {
	...
	if (json['result'] != null) {
		data.result = new ActivityBookingResponseResult().fromJson(json['result']);
	}
	return data;
}

Map<String, dynamic> activityBookingResponseEntityToJson(ActivityBookingResponseEntity entity) {
...
activityBookingResponseResultFromJson(ActivityBookingResponseResult data, Map<String, dynamic> json) {
	if (json['id'] != null) {
	...
	if (json['bookings'] != null) {
		data.bookings = new List<ActivityBookingResponseResultBooking>();
		(json['bookings'] as List).forEach((v) {
			data.bookings.add(new ActivityBookingResponseResultBooking().fromJson(v));
		});
	}
	if (json['contact'] != null) {
		data.contact = new ActivityBookingResponseResultContact().fromJson(json['contact']);
	}
	if (json['errors'] != null) {
		data.errors = new ActivityBookingResponseResultErrors().fromJson(json['errors']);
	}
...
Map<String, dynamic> activityBookingResponseResultToJson(ActivityBookingResponseResult entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
	data['uid'] = entity.uid;
...
activityBookingResponseResultBookingFromJson(ActivityBookingResponseResultBooking data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id']?.toInt();
	}
	if (json['uid'] != null) {
	...
	if (json['invoicePath'] != null) {
		data.invoicePath = json['invoicePath']?.toString();
	}
...
Map<String, dynamic> activityBookingResponseResultBookingToJson(ActivityBookingResponseResultBooking entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
	data['uid'] = entity.uid;
	data['bookingId'] = entity.bookingId;
...
activityBookingResponseResultContactFromJson(ActivityBookingResponseResultContact data, Map<String, dynamic> json) {
	if (json['id'] != null) {
...
Map<String, dynamic> activityBookingResponseResultContactToJson(ActivityBookingResponseResultContact entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
	data['uid'] = entity.uid;
...
activityBookingResponseResultErrorsFromJson(ActivityBookingResponseResultErrors data, Map<String, dynamic> json) {
	return data;
}

Map<String, dynamic> activityBookingResponseResultErrorsToJson(ActivityBookingResponseResultErrors entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	return data;
}