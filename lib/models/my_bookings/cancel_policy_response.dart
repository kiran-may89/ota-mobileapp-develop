...
class CancelPolicyResponse {
  ...
  factory CancelPolicyResponse.fromJson(String str) => CancelPolicyResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory  CancelPolicyResponse.fromMap(Map<String, dynamic> json) =>  CancelPolicyResponse(
