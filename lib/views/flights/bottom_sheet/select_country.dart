...
class SelectCountry extends StatefulWidget {
  ...
  SelectCountry(this.model, this.context, this.index, this.passengerType);

  @override
  _SelectCountryState createState() => _SelectCountryState(model,context,index,passengerType);
}
...
class _SelectCountryState extends State<SelectCountry> {
  ...
  _SelectCountryState(this.model, this.context, this.index, this.passengerType
      );
                    ...
                    child:
                              ...
                              itemBuilder: (context, index) {
                                return InkWell(
                                  ...
                                  model.setNationality(index,passengerType,model.tempCountryCodes[index].alpha2Code);
