          ...
          child: Column(
            ...
            children: <Widget>[
              GestureDetector(
                ...
                child: Card(
                    //elevation: 3,
                    margin: EdgeInsets.only(top: SizeConstants.SIZE_30,
              ...
              Container(
                  margin: EdgeInsets.only(
                  //right: SizeConstants.SIZE_16, left: SizeConstants.SIZE_16,
                ...
                Column(
                  ...
                  children: <Widget>[
                    ...
                    Card(
                      ...
                      child: Container(
                          margin: EdgeInsets.only(
                              top: SizeConstants.SIZE_20, left: SizeConstants.SIZE_10, bottom: SizeConstants.SIZE_16,
                                    ...
                                    Row(
                                      children: <Widget>[
                                        IconButton(
                                            ...
                                            onPressed: (){
                                              model.addChildCount(false, index);
                                            }
                                                ...
                                                Card(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: TextFormField(
                                                        ...
                                                        onChanged:(value) =>model.updateChildAge(index,ind,value),
              ...
              Container(
                ...
                margin: EdgeInsets.only(
                   // left: SizeConstants.SIZE_20, right: SizeConstants.SIZE_20,
                    top: SizeConstants.SIZE_20, bottom: SizeConstants.SIZE_20),
                child: RaisedButton(
                    color: CustomColors.Orange,
                    child: Text(
