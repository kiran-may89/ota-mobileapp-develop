...
class PackageResults extends StatefulWidget {
  @override
  _PackageResultsState createState() => _PackageResultsState();
}

class _PackageResultsState extends State<PackageResults> {
  ...
  Widget build(BuildContext context) {
    ...
    width = MediaQuery.of(context).size.width/10;
       ...
       return ChangeNotifierProvider<PackageResultsViewModel>(

    create: (context) =>PackageResultsViewModel(),
    child:
    Consumer<PackageResultsViewModel>(
    ...
    appBar: AppBar(title: Text('Package Results',style: CustomStyles.appbar,),
    ...
    children: <Widget>[
    IconButton(
    icon:   Icon(Icons.tune,color: CustomColors.White,size: 20,),
    ...
    crossAxisAlignment: CrossAxisAlignment.start,
    children: <Widget>[
    Text("Popular Packages",style: CustomStyles.heading,),
//    SizedBox(height: 7,),
//    Wrap(spacing: 1.2,
//
...
//    ],)
    ...
    child: Text('EDIT',style:CustomStyles.calenderStyle.copyWith(color: CustomColors.White,fontSize:11 ) ,),
    elevation: 3,
    ...
    child: Row(
    children: <Widget>[
    Expanded(child: Container(margin: EdgeInsets.only(bottom: 10),
    child: Text('Price :',style:CustomStyles.button_style.copyWith(fontSize: 13) ,
    ...
    Expanded(child: GestureDetector(child: Text('Low-High',
    style: model.Price_Filter==false? CustomStyles.button_style.copyWith(fontSize: 13) :
    CustomStyles.button_style.copyWith(fontSize: 13,color: CustomColors.White.withOpacity(.5)),
    textAlign: TextAlign.center,
    ),
    onTap: (){
    ...
    Expanded(child: GestureDetector(child: Text('High-Low',
    style: model.Price_Filter? CustomStyles.button_style.copyWith(fontSize: 13) :
    CustomStyles.button_style.copyWith(fontSize: 13,color: CustomColors.White.withOpacity(.5)),
    textAlign: TextAlign.center,
    ),
    onTap:(){
    ...
    child: Container(height: 2,width: 30,color: CustomColors.White,),
    ),
    ...
    primary: false,
    shrinkWrap: true,padding: EdgeInsets.only(bottom:MediaQuery.of(context).size.height*.12),
    ...
    style: CustomStyles.normal18.copyWith(color: CustomColors.heading,),
    children: <TextSpan>[
    TextSpan(text: " -"+ model.packageResultList.result[index].description,
    style: CustomStyles.normal16.copyWith(color: CustomColors.BackGround)
      ...
      text: TextSpan(
      text:  "SAR ",
      style: CustomStyles.normal14.copyWith(fontWeight: FontWeight.bold, color: CustomColors.BackGround),
      children: <TextSpan>[
      TextSpan(text: "0.00",
...
//              ),
    ...
    child: Text(
      model.
    packageResultList.result.length.toString(),
