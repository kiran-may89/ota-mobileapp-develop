...
BuildContext context;
  ...
  CurrencySelector(this.model, this.context);

  @override
  _CurrencySelectorState createState() => _CurrencySelectorState(model,context);
}
...
var width;
  ...
  _CurrencySelectorState(this.model, this.context);
...
//                        ),
  ...
  model.searchCurrencyList(text);
  },


  decoration: InputDecoration.collapsed(hintText:  "Search Currency" ,
  ...
  itemCount: model.tempCurrencyList.length,
  itemBuilder: (context, index) {
  return InkWell(
  onTap: (){

  model.setCurrency(model.tempCurrencyList[index],);

  print(model.tempCurrencyList[index]);
  ...
  SvgPicture.network(
  model.tempCurrencyList[index].flagUrl,
  height: 15,
  width: 15,
  )
...
//                                              ),
  ...
  model.tempCurrencyList[index].currencyCode,
  style:
  CustomStyles.bold16,
  ),
//                                                  SizedBox(
