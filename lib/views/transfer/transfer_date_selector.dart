...
class TransferDateSelector extends StatefulWidget {

  TransferPassengerModel model;

  BuildContext context;

  String selectionType;

  TransferDateSelector(this.model, this.context, this.selectionType);

  @override
  _TransferDateSelectorState createState() => _TransferDateSelectorState(this.model, this.context, this.selectionType);
}

class _TransferDateSelectorState extends State<TransferDateSelector> {
  ...
  _TransferDateSelectorState(this.model, this.context, this.selectionType);
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider.value(
        value: model,
        child: Consumer<TransferPassengerModel>(builder: (context, model, child) {
          return
            Container(
...
//        }
  ...
  Widget _calendarDates(Calendar calendarDate) {
    return InkWell(
      onTap: () {
        if ( calendarDate.date.isAtSameMomentAs(DateTime.now()) || calendarDate.date.isAfter(DateTime.now()) || calendarDate.date == DateTime.now()) {
...
//        } else if (_selectedToDateTime != null && _selectedDate != null) {
  ...
  void initState() {
    ...
    if(selectionType=="destination"){
      ...
      if(model.destinationDate!=null){
        DateTime dateTime = DateFormat("yyyy-MM-dd").parse(model.destinationDate);
      ...
      if(model.pickUpDate!=null){
        DateTime dateTime = DateFormat("yyyy-MM-dd").parse(model.pickUpDate);
        print(dateTime);
        _currentDateTime = DateTime(dateTime.year, dateTime.month);
        model.tempDate = dateTime;
      }else{
